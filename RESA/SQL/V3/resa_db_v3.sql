...
ALTER TABLE `Restaurant_mark` ADD FOREIGN KEY (`idClient`) REFERENCES `Client` (`id`);
...
ALTER TABLE `Client_mark` ADD FOREIGN KEY (`idClient`) REFERENCES `Client` (`id`);

ALTER TABLE `is_manager` ADD FOREIGN KEY (`idEmployee`) REFERENCES `Employe` (`id`);
