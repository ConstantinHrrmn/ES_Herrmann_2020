...
if(isset($_SESSION['etab']) && isset($_SESSION['user'])){
    ...
    if($etab->subscription == 3){
        ...
        if(isset($_POST['modifierhoraire'])){
            if(isset($_POST['begin']) && isset($_POST['end']) && isset($_POST['did']) ){
                $begin = $_POST['begin'];
                $end = $_POST['end'];
                $day = $_POST['did'];
                ...
                $link1 = $path."etablishment/schudle/get?change&".http_build_query($queryData);
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-fh">
                                ...
                                <div class="ms-panel-body">
                                            ...
                                            endforeach; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a style="color:black" data-toggle="modal"
                                                            data-target="#modal-<?php echo $schudle->did?>">[modifier]</a>
                                                    </td>
                                                    <?php endforeach; ?>
                                                </tr>
                                            </tbody>
                                    ...
                                    <?php foreach($schudles as $schudle) :?>
                                    <div class="modal fade" id="modal-<?php echo $schudle->did?>" tabindex="-1"
                                        role="dialog" aria-labelledby="modal-9">
                                        <div class="modal-dialog modal-dialog-centered modal-min" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <h1><?php echo $schudle->dname?></h1>
                                                    <form action="#" method="post" enctype="multipart/form-data"
                                                        id="creationEtablissement">

                                                        <div class="form-row">
                                                            <div class="col-md-6 mb-12">
                                                                <label for="valid3">Début</label>
                                                                <div class="input-group">
                                                                    <select class="form-control" id="begin"
                                                                        name="begin">
                                                                        <?php for($h = 0; $h < 24; $h++): ?>
                                                                        <?php for($m = 0; $m < 60; $m+=15): ?>
                                                                        <option
                                                                            value="<?php echo sprintf("%02d:%02d", $h, $m);?>">
                                                                            <?php echo sprintf("%02d:%02d", $h, $m);?>
                                                                        </option>
                                                                        <?php endfor; ?>
                                                                        <?php endfor; ?>
                                                                    </select>
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="form-check">
                                                                        <input type="checkbox" class="form-check-input"
                                                                            id="exampleCheck1" name="closed">
                                                                        <label class="form-check-label"
                                                                            for="exampleCheck1">Fermé</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <input type="text" name="did" id="did"
                                                            value="<?php echo $schudle->did ?>" hidden>

                                                        <input type="submit" class="btn btn-primary shadow-none"
                                                            value="Modifier" name="modifierhoraire">
                                                    </form>
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="ms-panel ms-panel-fh">
                                ...
                                <div class="ms-panel-body">
                                    <div class="table-responsive">
                                        <a class="btn btn-secondary" style="width: 100%;"
                                            href="../communes/employes.php">Gestion des employés</a>
                                    </div>
                                </div>
                            </div>
                        </div>
